 ...
 */
extern double configured_adjPi_kp;

/**
 * When set to a non-zero value, this variable determines the
 * integral constant for the PI controller.
 */
extern double configured_adjPi_ki;
 ...
 */
extern double configured_adjPi_kp_scale;
 ...
 * kp = min(kp_scale * sync^kp_exponent, kp_norm_max / sync)
 */
extern double configured_adjPi_kp_exponent;
 ...
 * kp = min(kp_scale * sync^kp_exponent, kp_norm_max / sync)
 */
extern double configured_adjPi_kp_norm_max;
 ...
 */
extern double configured_adjPi_ki_scale;
 ...
 * ki = min(ki_scale * sync^ki_exponent, ki_norm_max / sync)
 */
extern double configured_adjPi_ki_exponent;
 ...
 * ki = min(ki_scale * sync^ki_exponent, ki_norm_max / sync)
 */
extern double configured_adjPi_ki_norm_max;
 ...
 */
extern double configured_adjPi_offset;
