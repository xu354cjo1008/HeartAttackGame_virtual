...
/* Define to 1 if you have the declaration of `MSG_ERRQUEUE', and to 0 if you
   don't. */
#define HAVE_DECL_MSG_ERRQUEUE 0
...
/* Define to 1 if `tick' is a member of `struct timex'. */
/* #undef HAVE_STRUCT_TIMEX_TICK */
...
#define PACKAGE_BUGREPORT "ptpd-bugs@nwtime.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ptpd"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ptpd 2.3.0"
