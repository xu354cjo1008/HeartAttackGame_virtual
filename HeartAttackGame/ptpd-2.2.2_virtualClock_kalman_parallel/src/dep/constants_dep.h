...
#define DEFAULT_PTP_DOMAIN_ADDRESS     "224.0.1.129"   //orginal
//#define DEFAULT_PTP_DOMAIN_ADDRESS     "224.0.0.1"       //all systems
//#define DEFAULT_PTP_DOMAIN_ADDRESS     "172.20.10.254"    //hotspot
//#define DEFAULT_PTP_DOMAIN_ADDRESS     "169.254.1.129"  //mac ad hoc
//#define DEFAULT_PTP_DOMAIN_ADDRESS     "239.0.1.129"   //test

//define DEFAULT_PTP_DOMAIN_ADDRESS     "192.168.0.255"    //lab207
//#define DEFAULT_PTP_DOMAIN_ADDRESS     "224.0.0.130"   //local unassigned
//#define DEFAULT_PTP_DOMAIN_ADDRESS     "224.0.0.3"   //local unassigned
//#define DEFAULT_PTP_DOMAIN_ADDRESS     "224.0.1.200"   //internet unassigned

#define PEER_PTP_DOMAIN_ADDRESS        "224.0.0.107"
//#define PEER_PTP_DOMAIN_ADDRESS        "172.20.10.200"
