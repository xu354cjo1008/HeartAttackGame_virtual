...
void unpackPhysicalAddress2( Octet* buf, PhysicalAddress2*, PtpClock*);
void packPhysicalAddress2( PhysicalAddress2*, Octet*);
void freePhysicalAddress2( PhysicalAddress2*);
...
void displayStats(RunTimeOpts *rtOpts, PtpClock *ptpClock, struct virClock *virClock);
 ...
 * -Handle with timers*/
 /**\{*/
//void initTimer(void);
//void initTimer(struct virClock*);
void initTimer(struct virClock *virClock);
